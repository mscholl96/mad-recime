...
class TitleDataModule(pl.LightningDataModule):
    ...
    def __init__(self, data_dir: str = "path/to/dir", num_workers=4, config={}, setSize=8):
        super().__init__()
    ...
    def setup(self, stage = None):
        ...
        titleSet = TitleSet(self.data_dir, setSize=self.setSize)
